...
variable "envoy_config" {
  ...
  default = "envoy-staging.yaml"
}


job "asr4-staging-gpu" {
  datacenters = ["dc1"]
  type        = "service"
  ...
  group "asr4-group" {
    ...
    task "asr4-gpu-en-us-service" {
      ...
      config {
        image              = "${var.DOCKER_REGISTRY}/staging/asr4-gpu-en-us:${var.VERSION}"
      ...
      service {
        name = "asr4-gpu-en-us-staging-service"
        port = "grpc-port-en-us"
    ...
    task "asr4-gpu-es-service" {
      ...
      config {
        image              = "${var.DOCKER_REGISTRY}/staging/asr4-gpu-es:${var.VERSION}"
        ports              = ["grpc-port-es"]
      }
      ...
      service {
        name = "asr4-gpu-es-staging-service"
        port = "grpc-port-es"
    ...
    task "asr4-gpu-pt-br-service" {
      ...
      config {
        image              = "${var.DOCKER_REGISTRY}/staging/asr4-gpu-pt-br:${var.VERSION}"
      ...
      service {
        name = "asr4-gpu-pt-br-staging-service"
        port = "grpc-port-pt-br"
